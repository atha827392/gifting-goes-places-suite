...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 texture-leather">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-bronze/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
